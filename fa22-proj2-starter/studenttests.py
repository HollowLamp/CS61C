...
class TestAbsLoss(unittest.TestCase):
    def test_absloss_standard(self):
        ...
        t.check_array(array2, [6, 4, 2, 0, 2, 4, 6])
...
class TestSquaredLoss(unittest.TestCase):
    def test_squaredloss_standard(self):
    ...
    # Add other test cases if neccesary
    def test_squaredloss_length0(self):
        t = AssemblyTest(self, "../coverage-src/squared_loss.s")
        t.input_scalar("a2", 0)
        t.call("squared_loss")
        t.execute(code = 36)
...
class TestZeroOneLoss(unittest.TestCase):
    def test_zeroone_standard(self):
        ...
        # check that the result array contains the correct output
        t.check_array(array2, [0, 0, 0, 1, 0, 0, 0])
        # generate the `assembly/TestAbsLoss_test_simple.s` file and run it through venus
        t.execute()

    def test_zeroone_length0(self):
        t = AssemblyTest(self, "../coverage-src/zero_one_loss.s")
        t.input_scalar("a2", 0)
        t.call("zero_one_loss")
        t.execute(code = 36)
...
class TestInitializeZero(unittest.TestCase):
    def test_initialzezero_standard(self):
        ...
        t.check_array_pointer("a0", [0, 0, 0, 0, 0, 0, 0])
        t.execute()

    # Add other test cases if neccesary
    def test_initialzezero_length0(self):
        t = AssemblyTest(self, "../coverage-src/initialize_zero.s")
    ...
    def test_initialzezero_malloc(self):
        t = AssemblyTest(self, "../coverage-src/initialize_zero.s")
