...
#spend much time and get a wrong, almost no time to sleep so just copy an answer 
#from https://github.com/HangX-Ma/cs61c-sp22/blob/main/project2/src/classify.s
classify:
    # Prologue
    addi    sp, sp, -64
    sw      s0, 12(sp)
